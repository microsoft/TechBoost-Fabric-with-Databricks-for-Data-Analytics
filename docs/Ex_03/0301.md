...
7. Go to the **ContosoSales{Unique_ID}** workspace and select the **01 Marketing Data to Lakehouse (Bronze) - Code-First Experience** notebook.
...
14. Go to the cell with name **Shortcut Folder Path**, replace **#WORKSPACE_NAME#** with **ContosoSales{Unique_ID}**.
